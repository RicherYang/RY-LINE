...
<table class="form-table" role="presentation">
    <tr>
        <th scope="row"><?php esc_html_e('Enable tracking', 'ry-line'); ?></th>
        <td>
            <fieldset>
                <legend class="screen-reader-text"><span><?php esc_html_e('Enable tracking', 'ry-line'); ?></span></legend>
                <label for="tracking"><input name="tracking" type="checkbox" id="tracking" value="yes" <?php checked(Utils::string_to_bool(get_option('RY_General_tracking', 'yes'))); ?>>
                    <?php esc_html_e('Allow usage of RY Plugin to be tracked', 'ry-line'); ?></label>
                <p class="description">
                    <?php echo wp_kses(sprintf(
                        __('Read about what usage data is tracked at: %s .', 'ry-line'),
