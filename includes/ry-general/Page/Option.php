...
final class Option extends AbstractAdminPage
{
    ...
    {
        echo '<div class="wrap">';
        echo '<h1 class="wp-heading">' . esc_html__('Options', 'ry-line') . '</h1>';

        echo '<form method="post" action="' . esc_url(admin_url('admin-post.php')) . '">';
        include __DIR__ . '/html/options.php';
        Utils::the_action_form_button('general-option', 'save-option', __('Save Changes', 'ry-line'), 'submit', 'button-primary');
        echo '</form>';
