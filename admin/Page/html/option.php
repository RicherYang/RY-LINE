...
<table class="form-table">
    <tbody>
        <tr>
            ...
            <td>
                <input name="channel-id" type="text" class="regular-text" value="<?php echo esc_attr(Main::get_option('channel_id')); ?>">
        ...
        <tr>
            ...
            <td>
                <input name="channel-secret" type="text" class="regular-text" value="<?php echo esc_attr(Main::get_option('channel_secret')); ?>">
            </td>
        </tr>
        <tr>
            <th><label for="test-user-id"><?php esc_html_e('Test user ID', 'ry-line'); ?></label></th>
            <td>
                <input name="test-user-id" type="text" class="regular-text" value="<?php echo esc_attr(Main::get_option('test_user_id')); ?>">
