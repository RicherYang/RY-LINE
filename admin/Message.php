...
final class Message
{
    ...
    protected function do_init(): void
    {
        ...
        add_filter('manage_' . Main::POSTTYPE_MESSAGE . '_posts_columns', [$this, 'add_columns']);
        add_filter('manage_' . Main::POSTTYPE_MESSAGE . '_posts_custom_column', [$this, 'show_columns'], 10, 2);
        add_filter('wp_insert_post_data', [$this, 'change_post_data']);
        add_action('save_post_' . Main::POSTTYPE_MESSAGE, [$this, 'save_date'], 10, 2);
    }

    public function skip_quick_edit($enabled, $post_type)
    {
        if ($post_type === Main::POSTTYPE_MESSAGE) {
            return false;
        }
    ...
    {
        if ($data['post_type'] === Main::POSTTYPE_MESSAGE) {
